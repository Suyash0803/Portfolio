...
const skills = [
  ...
  { name: "SQL", icon: "devicon-mysql-plain" },           // or "devicon-postgresql-plain"
  { name: "Postman", icon: "devicon-postman-plain" },
  { name: "Redis", icon: "devicon-redis-plain" },
  { name: "AWS", icon: "devicon-amazonwebservices-original" },
  { name: "Docker", icon: "devicon-docker-plain" },
  { name: "Prometheus", icon: "devicon-prometheus-original" }, // If not supported, use a placeholder or custom SVG
  { name: "Canva", icon: "devicon-canva-original" },      // Not in devicon: consider a custom icon or omit
  { name: "Linux", icon: "devicon-linux-plain" },
  // { name: "C++", icon: "devicon-cplusplus-plain" },
  { name: "Java", icon: "devicon-java-plain" },
  { name: "ESLint", icon: "devicon-eslint-original" },
